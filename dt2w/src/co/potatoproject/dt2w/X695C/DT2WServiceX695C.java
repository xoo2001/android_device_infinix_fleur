...
public class DT2WServiceX695C extends Service {
    private static final String TAG = "DT2WServiceX695C";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.X695C.dt2w", dt2wEnabled ? "1" : "0");
        }
