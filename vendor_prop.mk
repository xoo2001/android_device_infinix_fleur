...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.bootimage.build.date.utc=1650299236 \
    ro.bootimage.build.date=Tue \
    Apr \
    00:27:16 \
    CST \
    2022 \
    ro.bootimage.build.fingerprint=Redmi/fleur/fleur:11/RP1A.200720.011/V13.0.7.0.RKEMIXM:user/release-keys \
    ...
    ro.miui.version.code_time=1650297600 \
    ro.mtk_cam_dualzoom_support=1 \
    ro.mtk_key_manager_support=1 \
    ro.odm.build.date.utc=1650299236 \
    ro.odm.build.date=Tue \
    ro.odm.build.fingerprint=Redmi/fleur/fleur:11/RP1A.200720.011/V13.0.7.0.RKEMIXM:user/release-keys \
    ro.odm.build.id=RP1A.200720.011 \
    ro.odm.build.tags=release-keys \
    ro.odm.build.type=user \
    ro.odm.build.version.incremental=V13.0.7.0.RKEMIXM \
    ...
    ro.system_ext.build.date.utc=1650299236 \
    ro.system_ext.build.date=Tue \
    ro.system_ext.build.fingerprint=Redmi/fleur/fleur:11/RP1A.200720.011/V13.0.7.0.RKEMIXM:user/release-keys \
    ro.system_ext.build.id=RP1A.200720.011 \
    ro.system_ext.build.tags=release-keys \
    ro.system_ext.build.type=user \
    ro.system_ext.build.version.incremental=V13.0.7.0.RKEMIXM \
    ...
    ro.vendor.build.date.utc=1650299236 \
    ...
    ro.vendor.build.version.incremental=V13.0.7.0.RKEMIXM \
